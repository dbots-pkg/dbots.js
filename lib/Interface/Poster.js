...
var Poster = /** @class */ (function () {
    ...
    Poster.prototype.getService = function (service) {
        var _this_1 = this;
        var serviceClass = Service_1.default.get(service, this.customServices);
        if (!serviceClass)
            return null;
        if (!Object.prototype.isPrototypeOf.call(Service_1.default, serviceClass))
            return serviceClass;
    ...
    Poster.prototype.postManual = function (service, counts) {
        ...
        if (service === 'custom')
            // @ts-expect-error
            return EnsurePromise_1.default(
            // @ts-expect-error
        ...
        if (service === 'all') {
            ...
            return promise_allsettled_1.default(services.map(function (k) {
