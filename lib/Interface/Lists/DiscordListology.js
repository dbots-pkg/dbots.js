...
var DiscordListology = /** @class */ (function (_super) {
    ...
    DiscordListology.prototype.userVotedBot = function (id, userID) {
        return this._request({ url: "/bots/" + Util_1.default.resolveID(userID) + "/hasvoted/" + Util_1.default.resolveID(id) });
    };
    /**
    ...
    DiscordListology.prototype.userVotedGuild = function (id, userID) {
        return this._request({ url: "/guilds/" + Util_1.default.resolveID(userID) + "/hasvoted/" + Util_1.default.resolveID(id) });
    };
    return DiscordListology;
