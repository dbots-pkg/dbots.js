...
var ListMyBots = /** @class */ (function (_super) {
    ...
    ListMyBots.post = function (options) {
        ...
        return _super._post.call(this, {
            ...
            data: { count: Util_1.default.resolveCount(serverCount) }
        });
    };
    /**
    ...
    ListMyBots.prototype.getStatusWidgetURL = function (id, query) {
        return this._appendQuery("https://listmybots.com/api/bot/" + Util_1.default.resolveID(id) + "/widget/status", query || {}, false);
    };
    /**
    ...
    ListMyBots.prototype.getWidgetURL = function (id, query) {
        return this._appendQuery("https://listmybots.com/api/bot/" + Util_1.default.resolveID(id) + "/widget", query || {}, false);
    };
    return ListMyBots;
}(Service_1.default));
