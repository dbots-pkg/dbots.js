...
var messageObject = {
    ...
    UNKNOWN_CLIENT: function (count_name) { return "Can't retrieve " + count_name + " count from non-existant client."; },
    NO_CLIENT: function (count_name) { return "Can't retrieve " + count_name + " count from unknown client."; },
    NO_API_KEYS: 'Can\'t post with a poster that has no API keys.',
    SERVICE_NO_KEY: function (service) { return "Can't post to \"" + service + "\" without an API key."; },
    ...
    UNSUPPORTED_EVENT: function (action) { return "Can't " + action + " handler for an unsupported event."; },
    CALLED_FROM_BASE: 'This function needs to be called by an extended class.',
    REQUIRES_TOKEN: 'This endpoint requires a token.',
    POSTING_UNSUPPORTED: function (service) { return "The service " + service + " does not support posting."; },
